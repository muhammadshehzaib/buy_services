      ...
      <div className="txt sm:mt-20 min-[1px]:mt-12 flex flex-col items-center">
        ...
        <div className="sm:flex justify-between mt-5 full input-sec w-3/4">
          ...
          <div className="sm:w-[47%]">
            ...
            <select id="Tone" className="bg-transparent py-5 pl-8 w-full border-2 border-black rounded-full pr-32">
        ...
        <div className="w-3/4 mt-5">
          ...
          <textarea name="" id="Des" className="bg-transparent py-5 pl-8 w-full border-2 border-black rounded-2xl pr-32 h-36" placeholder="Easy Ways to Make"></textarea>
        </div>
        <a
          href=""

          ...
          <div className="step-one lg:flex">
            ...
            <div className="text-sec md:w-full">
              ...
              <li className='text-[18px] mb-5 flex'>
                ...
                <p className=''><span className='font-bold '>Strict it Rich |</span> YouTube Subscribers In this package, subscribers will be directed to your account immediately after you make a purchase.</p>
                </li>
                <li className='text-[18px] mb-5 flex'>
                <span className='sm:w-3 mt-2 mr-2 h-2 min-[1px]:w-6 bg-red-500 rounded-full  '></span>
                <p className=''><span className='font-bold '>Better Late Than Never |</span> YouTube Subscribers This package will gradually direct subscribers to your YouTube account, instead of all at once.</p>
                </li>
                <li className='text-[18px] mb-5 flex'>
                <span className='sm:w-2 mt-2 mr-2 h-2 min-[1px]:w-6 bg-red-500 rounded-full  '></span>
                <p className=''><span className='font-bold '>Turbo Likes</span> These are the immediate likes for your chosen video content.</p>
                </li>
                <li className='text-[18px] mb-5 flex'>
                <span className='sm:w-2 mt-2 mr-2 h-2 min-[1px]:w-6 bg-red-500 rounded-full  '></span>
                <p className=''><span className='font-bold '>Spreading Likes </span> These are the gradually provided likes for your perfectly designed content.
                </p>
                </li>
                <li className='text-[18px] mb-5 flex'>
                <span className='sm:w-2 mt-2 mr-2 h-2 min-[1px]:w-6 bg-red-500 rounded-full  '></span>
                <p className=''><span className='font-bold '>% 100 Genuinely Fast Views</span> Get the most valued views as fastest and safest as you can.</p>
                </li>
                <li className='text-[18px] mb-5 flex'>
                <span className='sm:w-2 mt-2 mr-2 h-2 min-[1px]:w-6 bg-red-500 rounded-full '></span>
                <p className=''><span className='font-bold '>% 100 Genuinely Slow Views </span> Sometimes it’s best to get them one by one.</p>
                </li>
              </ul>
            </div>
          </div>

  ...
  return (
    <div className='max-w-[1390px] px-5 mx-auto'>
      <div className="txt sm:mt-28 sm:mb-20 min-[1px]:my-6 flex flex-col items-center">
        <h2 className="text-3xl md:w-[65%] uppercase sm:text-3xl min-[1px]:text-[24px] font-bold text-center sm:mb-16 min-[1px]:mb-6 dark:text-white">
      ...
      <div className="main lg:flex pb-24">
        <div className="fst-sec lg:border-r-2 lg:border-[#E6E6E6] lg:pr-16 lg:w-full">
          <h2 className='text-[32px]  sm:mb-10 min-[1px]:mb-5 font-bold dark:text-white'>What is Instagram Story Viewer?</h2>
          ...
          <h2 className='text-[32px] font-bold sm:mb-16 min-[1px]:mb-8 min-[1px]:leading-9 sm:leading-normal dark:text-white'>How to Use Views4You Instagram Story Viewer</h2>
          ...
          <p className='mb-5 text-[18px] dark:text-white'>Instagram story viewer is easy to use. </p>
          <ul className='list-disc mb-8 text-[18px] '>
            <li className='dark:text-white'>Write the username or the Instagram account’s URL on the given box. </li>
            <li className='dark:text-white'>Press the ‘search’ button. </li>
            <li className='dark:text-white'>You can now view the stories.</li>
          </ul>
          <p className='dark:text-white'>You can also use our tool as ‘Instagram Story Downloader’ to download the Instagram story of the user. However, one thing to know is that the account you want to view must be public. If you try to view any private account, it will not be allowed by Instagram’s terms of service. In the pursuit of maximizing your reach and ensuring your stories garner significant attention, you may also want to <span className='text-[#ed2024]'><a href="/insta" className='dark:text-white'>buy Instagram followers</a></span> to grow your audience base effectively.</p>
          <h2 className='text-[32px] font-bold sm:mt-16 min-[1px]:mt-8 dark:text-white'>Instagram Story Viewer Features</h2>
          <p className='mb-5 text-[18px] dark:text-white'>Enormous features that you can benefit from:</p>
          <ul className='list-disc mb-8 text-[18px]'>
            <li className='dark:text-white'><span className='font-bold dark:text-white'>View Instagram Story Anonymously: </span>You can keep your privacy safe while viewing Instagram stories. Your name and details will be hidden and you don’t need to have an Instagram account to do that. </li>
            <li className='dark:text-white'><span className='font-bold dark:text-white'>No Membership & No Identification Details: </span> The tool is very easy and user-friendly. You can simply view stories without signing up on the page.  </li>
            <li className='dark:text-white'> <span className='font-bold dark:text-white'>Completely Free: </span>The tool is absolutely free and you can use it anytime and anywhere.  </li>
            <li className='dark:text-white'><span className='font-bold dark:text-white'>No Proof! No Sign: </span> You can view an Instagram story anonymously without leaving any name details to the user.</li>
            <li className='dark:text-white'><span className='font-bold dark:text-white'>HQ Downloader: </span>It allows you to download Instagram stories in high-quality fast and easy with this tool. Simply click on download and save stories fast. </li>
          </ul>
          <h2 className='text-[32px] font-bold sm:mt-16 min-[1px]:mt-8 dark:text-white'>Benefits of Using Our Instagram Viewer Tool</h2>
